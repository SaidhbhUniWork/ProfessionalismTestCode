...
bq = tk.Button(my_w_1, text='Search Query', width=12, bg='light grey', command=execute_query, font = ('bold', 10))
...
lbl_sqlSearch = tk.Label(my_w_1, text='Search by Query:', width=15, anchor="e", font=('bold', 10))
lbl_sqlSearch.grid(row=3, column=10, sticky=W)

# Scroll box for query text input
query_search_entry = ScrolledText(my_w_1, height = 0, width=15)
query_search_entry.grid(row=3, column=11)
